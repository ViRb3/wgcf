...
// checks if the GetBoundDevices200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBoundDevices200Response{}
...
type _GetBoundDevices200Response GetBoundDevices200Response
...
func (o GetBoundDevices200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetBoundDevices200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBoundDevices200Response := _GetBoundDevices200Response{}

	err = json.Unmarshal(data, &varGetBoundDevices200Response)

	if err != nil {
		return err
	}

	*o = GetBoundDevices200Response(varGetBoundDevices200Response)
