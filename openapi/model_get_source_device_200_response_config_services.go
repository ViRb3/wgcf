...
// checks if the GetSourceDevice200ResponseConfigServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSourceDevice200ResponseConfigServices{}
...
type _GetSourceDevice200ResponseConfigServices GetSourceDevice200ResponseConfigServices
...
func (o GetSourceDevice200ResponseConfigServices) ToMap() (map[string]interface{}, error) {
...
func (o *GetSourceDevice200ResponseConfigServices) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSourceDevice200ResponseConfigServices := _GetSourceDevice200ResponseConfigServices{}

	err = json.Unmarshal(data, &varGetSourceDevice200ResponseConfigServices)

	if err != nil {
		return err
	}

	*o = GetSourceDevice200ResponseConfigServices(varGetSourceDevice200ResponseConfigServices)
