...
type GetClientConfig200ResponseDenylistInnerNetworks struct {
	V4 []GetClientConfig200ResponseDenylistInnerNetworksV4Inner `json:"v4"`
	V6 []GetClientConfig200ResponseDenylistInnerNetworksV6Inner `json:"v6"`
...
func (o *GetClientConfig200ResponseDenylistInnerNetworks) GetV4() []GetClientConfig200ResponseDenylistInnerNetworksV4Inner {
	if o == nil {
		var ret []GetClientConfig200ResponseDenylistInnerNetworksV4Inner
		return ret
	}
...
func (o *GetClientConfig200ResponseDenylistInnerNetworks) GetV6() []GetClientConfig200ResponseDenylistInnerNetworksV6Inner {
	if o == nil {
		var ret []GetClientConfig200ResponseDenylistInnerNetworksV6Inner
		return ret
	}
