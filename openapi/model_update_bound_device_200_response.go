...
// checks if the UpdateBoundDevice200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateBoundDevice200Response{}
...
type _UpdateBoundDevice200Response UpdateBoundDevice200Response
...
func NewUpdateBoundDevice200Response(activated string, active bool, created string, id string, model string, role string, type_ string) *UpdateBoundDevice200Response {
	this := UpdateBoundDevice200Response{}
...
func (o UpdateBoundDevice200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateBoundDevice200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateBoundDevice200Response := _UpdateBoundDevice200Response{}

	err = json.Unmarshal(data, &varUpdateBoundDevice200Response)

	if err != nil {
		return err
	}

	*o = UpdateBoundDevice200Response(varUpdateBoundDevice200Response)
...
type NullableUpdateBoundDevice200Response struct {
	value *UpdateBoundDevice200Response
	isSet bool
}
...
func NewNullableUpdateBoundDevice200Response(val *UpdateBoundDevice200Response) *NullableUpdateBoundDevice200Response {
	return &NullableUpdateBoundDevice200Response{value: val, isSet: true}
}
