...
func (r ApiGetBoundDevicesRequest) Execute() ([]GetBoundDevices200Response, *http.Response, error) {
...
func (a *DefaultAPIService) GetBoundDevicesExecute(r ApiGetBoundDevicesRequest) ([]GetBoundDevices200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateBoundDeviceRequest) Execute() ([]UpdateBoundDevice200Response, *http.Response, error) {
...
func (a *DefaultAPIService) UpdateBoundDeviceExecute(r ApiUpdateBoundDeviceRequest) ([]UpdateBoundDevice200Response, *http.Response, error) {
	var (
